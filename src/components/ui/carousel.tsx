...
>(({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        'absolute  h-10 w-10 rounded-full text-primary-light border border-primary-light disabled:border-primary-light/50 disabled:text-primary-light/50 hover:text-primary hover:border-primary transition-colors duration-300',
        orientation === 'horizontal'
