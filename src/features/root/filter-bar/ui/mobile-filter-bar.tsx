...
import { LeftCarousel } from './left-gradient'
import { MobileFilterBarSkeleton } from './mobile-filter-bar-skeleton'
import { RightGradient } from './right-gradient'
...
export const MobileFilterBar = () => {
  ...
  return (
    <div className='relative mb-8 h-[47px] max-w-screen-sm md:hidden'>
      <Carousel
        opts={{
          align: 'start',
          slidesToScroll: 1,
