        ...
        <Tabs defaultValue='delivery'>
          ...
          <TabsContent value='pickup'>
            <div className='my-12 flex flex-col gap-8 md:flex-row md:gap-[62px] xl:gap-[180px]'>
              <div className='mr-auto max-h-min w-full flex-col rounded-[20px] border border-primary-light border-opacity-50 px-[10px] py-6 md:max-w-[220px] md:border-0 md:p-0'>
                <h3 className='mb-[18px] text-[18px]/[23.4px] font-medium'>
                  Адреса ресторану
                </h3>
