...
import { EditAdvantage } from '@/views/admin/advantages/ui/edit.page'
import { AdvantagesList } from '@/views/admin/advantages/ui/list.page'
import { EditCategory } from '@/views/admin/categories/ui/edit.page'
import { CategoriesList } from '@/views/admin/categories/ui/list.page'
import { EditProduct } from '@/views/admin/dishes/ui/edit.page'
import { ProductList } from '@/views/admin/dishes/ui/list.page'
import { EditIngredient } from '@/views/admin/ingredients/ui/edit.page'
import { IngredientList } from '@/views/admin/ingredients/ui/list.page'
import { ShowOrder } from '@/views/admin/orders/ui/id.page'
import { OrdersList } from '@/views/admin/orders/ui/list.page'
import { EditPost } from '@/views/admin/posts/ui/edit.page'
import { PostsList } from '@/views/admin/posts/ui/list.page'
